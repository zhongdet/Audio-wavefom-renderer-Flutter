...
class OffscreenGpuRenderer(private val activity: Activity) {
    ...
    private var eglDisplay: EGLDisplay = egl.eglGetDisplay(EGL10.EGL_DEFAULT_DISPLAY)
    ...
    private fun initEGL() {
        ...
        val surfaceAttribs = intArrayOf(
            EGL10.EGL_WIDTH, EGL_PBUFFER_WIDTH,
            EGL10.EGL_HEIGHT, EGL_PBUFFER_HEIGHT,
            EGL10.EGL_NONE
        )
    ...
    private fun initGL() {
        ...
        val fragmentShader = compileShader(android.opengl.GLES30.GL_FRAGMENT_SHADER, fragmentShaderSource)
        ...
        android.opengl.GLES30.glGetProgramiv(program, android.opengl.GLES30.GL_LINK_STATUS, linkStatus, 0)
        if (linkStatus[0] == 0) {
        ...
        android.opengl.GLES30.glTexParameteri(android.opengl.GLES30.GL_TEXTURE_2D, android.opengl.GLES30.GL_TEXTURE_MIN_FILTER, android.opengl.GLES30.GL_NEAREST)
        android.opengl.GLES30.glTexParameteri(android.opengl.GLES30.GL_TEXTURE_2D, android.opengl.GLES30.GL_TEXTURE_MAG_FILTER, android.opengl.GLES30.GL_NEAREST)
        ...
        android.opengl.GLES30.glTexParameteri(android.opengl.GLES30.GL_TEXTURE_2D, android.opengl.GLES30.GL_TEXTURE_WRAP_S, android.opengl.GLES30.GL_CLAMP_TO_EDGE)
        android.opengl.GLES30.glTexParameteri(android.opengl.GLES30.GL_TEXTURE_2D, android.opengl.GLES30.GL_TEXTURE_WRAP_T, android.opengl.GLES30.GL_CLAMP_TO_EDGE)
        android.opengl.GLES30.glTexImage2D(android.opengl.GLES30.GL_TEXTURE_2D, 0, android.opengl.GLES30.GL_R32I, BOUNDS_TEX_WIDTH, BOUNDS_TEX_HEIGHT, 0, android.opengl.GLES30.GL_RED_INTEGER, android.opengl.GLES30.GL_INT, null)
    }
    ...
    fun renderFrame(
        ...
        android.opengl.GLES30.glTexImage2D(
            android.opengl.GLES30.GL_TEXTURE_2D, 0, android.opengl.GLES30.GL_RGBA32F,
            MAX_BARS * 4, 1, 0, android.opengl.GLES30.GL_RGBA, android.opengl.GLES30.GL_FLOAT, barData
        )
        ...
        android.opengl.GLES30.glVertexAttribPointer(aPositionLoc, 2, android.opengl.GLES30.GL_FLOAT, false, 0, 0)
        ...
        android.opengl.GLES30.glReadPixels(0, 0, frameWidth, frameHeight, android.opengl.GLES30.GL_RGBA, android.opengl.GLES30.GL_UNSIGNED_BYTE, readBuffer)
    ...
    private fun buildBoundsTexture(
        frameWidth: Int, frameHeight: Int, barCount: Int,
        barHeights: FloatArray, barWidth: Float, barSpacing: Float
    ) {
        val buf = ByteBuffer.allocate(BOUNDS_TEX_WIDTH * BOUNDS_TEX_HEIGHT * 4)
        ...
        android.opengl.GLES30.glTexSubImage2D(
            android.opengl.GLES30.GL_TEXTURE_2D, 0, 0, 0,
            BOUNDS_TEX_WIDTH, BOUNDS_TEX_HEIGHT,
            android.opengl.GLES30.GL_RED_INTEGER, android.opengl.GLES30.GL_INT, buf
        )
    }
    ...
    private fun createVBO(data: FloatArray): Int {
        ...
        val buffer = ByteBuffer.allocateDirect(data.size * 4).order(ByteOrder.LITTLE_ENDIAN).asFloatBuffer().apply {
            put(data); position(0)
        }
        android.opengl.GLES30.glBufferData(android.opengl.GLES30.GL_ARRAY_BUFFER, data.size * 4, buffer, android.opengl.GLES30.GL_STATIC_DRAW)
        return vbo[0]
    }
}